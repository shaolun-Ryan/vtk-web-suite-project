...
exports._resolvePackageMap = (pkgMap) => Promise
    ...
    .then((pkgs) => Object.keys(pkgMap).reduce((obj, path, i) => pkgs[i] === null ? obj : Object.assign(Object.assign({}, obj), { [path]: pkgs[i] }), {}));
...
const _identifyCircularRefs = (pkg, refPath) => {
    ...
    return {
        ...
        refs: pkg.dependencies
            ...
            .reduce((memo, obj, i) => (Object.assign(Object.assign({}, memo), { [i]: obj })), {}),
    };
};
...
const _resolveRangesOrNull = (pkg, pkgMap, lastFilePath) => {
    ...
    // Mutate the object.
    const resolvedPkg = Object.assign(Object.assign({}, pkg), { 
        // Recurse.
        dependencies: pkg.dependencies
